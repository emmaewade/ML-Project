...
#test_file = "final_test_df.csv"
#train_file = "final_train_df.csv"
...
model.save('keras_model_conv2D_fixed.h5')

model = load_model('keras_model_conv2D_fixed.h5')
intermediate_layer_model = Model(inputs=model.input,
                                 outputs=model.get_layer('feature_dense').output) ##model for XGBoost prediction
intermediate_layer_model.summary()

model.train(X_train)

X_train_xg =intermediate_layer_model.predict(X_train) #XGBoost train
X_test_xg = intermediate_layer_model.predict(X_test) #XGBoost test
